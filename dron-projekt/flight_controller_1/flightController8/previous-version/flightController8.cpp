...
void loop() {
    ...
    upperRightPwm = 115 + inputThrottle - rollPid - pitchPid;   //motors pwm calculation
    downRightPwm = 115 + inputThrottle - rollPid + pitchPid;
    downLeftPwm = 115 + inputThrottle + rollPid + pitchPid;
    upperLeftPwm = 115 + inputThrottle + rollPid - pitchPid;
